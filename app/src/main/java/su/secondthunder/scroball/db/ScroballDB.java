...
import su.secondthunder.scroball.LastfmClient;
import su.secondthunder.scroball.PlaybackItem;
import su.secondthunder.scroball.ScroballApplication;
import su.secondthunder.scroball.Scrobble;
import su.secondthunder.scroball.ScrobbleStatus;
...
public class ScroballDB {
  ...
  public void clearScrobble () {
    Delete.table(ScrobbleLogEntry.class);
    Delete.table(PendingPlaybackItemEntry.class);
  }
   */
