...
public class LastfmClient {
  ...
  private static final String API_KEY = "3eaf1cd9322b0098b430368e115b2724";
  private static final String API_SECRET = "c9d47952b322685f20c44a4e9106af6b";
  ...
  public Uri getAuthUrl() {
    return Uri.parse(
        "https://www.last.fm/api/auth/?api_key=" + API_KEY + "&cb=scroball://authenticate");
  }
   ...
   */
  public void updateNowPlaying(su.secondthunder.scroball.Track track, Handler.Callback callback) {
  ...
  public void getTrackInfo(su.secondthunder.scroball.Track track, Handler.Callback callback) {
   ...
   */
  public void loveTrack(su.secondthunder.scroball.Track track, Handler.Callback callback) {
  ...
  @NonNull
  private ScrobbleData getScrobbleData(su.secondthunder.scroball.Track track, int timestamp) {
  ...
  private static class GetTrackInfoTask
      extends AsyncTask<su.secondthunder.scroball.Track, Object, Track> {
    private final Session session;
    private final Handler.Callback callback;
    private su.secondthunder.scroball.Track track;
    ...
    @Override
    protected Track doInBackground(su.secondthunder.scroball.Track... params) {
      track = params[0];
      try {
    ...
    protected void onPostExecute(Track updatedTrack) {
      ...
      if (updatedTrack != null) {
        su.secondthunder.scroball.Track.Builder builder =
            su.secondthunder.scroball.Track.builder()
                .artist(track.artist())
                .track(track.track())
  ...
  private static class LoveTrackTask
      extends AsyncTask<su.secondthunder.scroball.Track, Object, Result> {
    private final LastfmApi api;
    private final Session session;
    private final Handler.Callback callback;
    ...
    @Override
    protected Result doInBackground(su.secondthunder.scroball.Track... params) {
      su.secondthunder.scroball.Track track = params[0];
      try {
